            ...
            <div className="content-main flex flex-col items-center lg:w-1/2 sm:w-3/5 w-full">
              ...
              <div className="input-block w-full h-[52px] mt-6">
                <form className="w-full h-full relative" action="post">
                  <input
                    ...
                    className="caption1 w-full h-full pl-4 pr-14 rounded-xl border border-purple"
                    required
                  />
              ...
              <div className="list-link flex items-center gap-6 justify-center mt-6 text-[18px] text-white">
                <Link href={"https://www.facebook.com/"} target="_blank">
                  <div className="icon-facebook text-xl hover:text-secondary"></div>
                </Link>
                <Link href={"https://www.instagram.com/"} target="_blank">
                  <div className="icon-instagram text-xl hover:text-secondary"></div>
                </Link>
                <Link href={"https://www.youtube.com/"} target="_blank">
                  <div className="icon-youtube text-xl hover:text-secondary"></div>
                </Link>
                <Link href={"https://www.twitter.com/"} target="_blank">
                  <div className="icon-twitter text-xl hover:text-secondary"></div>
                </Link>
                <Link href={"https://www.pinterest.com/"} target="_blank">
                  <div className="icon-pinterest text-xl hover:text-secondary"></div>
                </Link>
              </div>
            </div>
          </div>
