    ...
    <div className="privacy-policy container mx-auto px-6 py-16">
      ...
      <section className="mb-10">
        ...
        <p className="text-gray-700 text-lg">
          Our website address is: <a href="https://theribbonpack.com" className="text-blue-500 underline">https://theribbonpack.com</a>.
        </p>
      </section>
      ...
      <section className="mb-10">
        ...
        <p className="text-gray-700 text-lg mb-4">
          An anonymized string created from your email address (also called a hash) may be provided to the Gravatar service to see if you are using it. The Gravatar service privacy policy is available here: <a href="https://automattic.com/privacy/" className="text-blue-500 underline">https://automattic.com/privacy/</a>.
        </p>
        <p className="text-gray-700 text-lg">
