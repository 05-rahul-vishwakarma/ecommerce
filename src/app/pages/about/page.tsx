        ...
        <div className="container mx-auto px-6 md:px-10">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-gray-700 text-lg leading-relaxed">
              Ribbons need no introduction. Over the years, they have
              transformed countless creative projects, from crafting elegant
              decorations to adding the perfect finishing touch to gifts. Our
              ribbons bring charm and sophistication to every occasion,
              inspiring your imagination and elevating your creations.
            </p>
          </div>

          {/* Company Profile Section */}
          <div className="company-profile bg-white shadow-md rounded-xl py-12 px-6 md:px-10 mb-16">
            <h2 className="text-3xl font-semibold text-secondary-800 text-center mb-6">
              Company Profile
            </h2>
            <p className="text-gray-700 text-lg leading-relaxed mb-8">
              The Ribbon Pack is a prestigious organization that provides
              customized foil or leaf-printed ribbons, as well as a wide range
              of gifting and decorative products like woven-edge satin ribbons,
              organza, gross grain ribbons, and birthday sashes.
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <p className="text-gray-700 text-lg leading-relaxed">
                Founded in 2021 in Delhi, India, we proudly serve bakeries and
                businesses across the city, delivering high-quality products and
                exceptional service. Our team works tirelessly to ensure
                satisfaction.
              </p>
              <p className="text-gray-700 text-lg leading-relaxed">
                We stand out with guaranteed quality, aesthetic appeal, and a
                commitment to precision using modern technology. Our transparent
                business practices set benchmarks in the industry.
              </p>
            </div>
          </div>
          ...
          <div className="services bg-gray-100 shadow-md rounded-xl py-12 px-6 md:px-10 mb-16">
            <h3 className="text-3xl font-semibold text-secondary-800 text-center mb-6">
              Our Services
            </h3>
