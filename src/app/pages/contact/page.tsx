                ...
                <div className="container">
                    <div className="flex justify-between max-lg:flex-col gap-y-10">
                        <div className="left lg:w-2/3 lg:pr-4">
                            <div className="heading3 text-secondary2">Drop Us A Line</div>
                        ...
                        <div className="right lg:w-1/4 lg:pl-4">
                            <div className="item">
                                <div className="heading4 text-secondary2">Our Store</div>
                            ...
                            <div className="item mt-10">
                                <div className="heading4 text-secondary2">Open Hours</div>
