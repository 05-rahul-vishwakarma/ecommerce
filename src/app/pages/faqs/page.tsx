        ...
        <div className="container">
          <div className="flex justify-between">
            <div className="left w-1/4">
              <div className="menu-tab flex flex-col gap-5">
                {[
                  ...
                  <div
                    key={index}
                    className={`tab-item inline-block w-fit heading6 has-line-before text-purple2 hover:text-secondary duration-300 ${
            ...
            <div className="right w-2/3">
              ...
              >
                <div
                  className={`question-item px-7 py-5 rounded-[20px] overflow-hidden border border-purple cursor-pointer ${
                    ...
                    <div className="flex justify-between">
                        ...
                        <div className="right w-2/3">
                            <div className={`tab-question flex flex-col gap-5 ${activeTab === 'how to buy' ? 'active' : ''}`}>
                                <div
                                    className={`question-item px-7 py-5 rounded-[20px] overflow-hidden border border-purple cursor-pointer ${activeQuestion === '1' ? 'open' : ''}`}
                                    onClick={() => handleActiveQuestion('1')}
                                >
                                    <div className="heading flex items-center justify-between gap-6">
                                ...
                                <div
                                    className={`question-item px-7 py-5 rounded-[20px] overflow-hidden border border-purple cursor-pointer ${activeQuestion === '2' ? 'open' : ''}`}
                                ...
                                <div
                                    className={`question-item px-7 py-5 rounded-[20px] overflow-hidden border border-purple cursor-pointer ${activeQuestion === '3' ? 'open' : ''}`}
                                ...
                                <div
                                    className={`question-item px-7 py-5 rounded-[20px] overflow-hidden border border-purple cursor-pointer ${activeQuestion === '4' ? 'open' : ''}`}
                                ...
                                <div
                                    className={`question-item px-7 py-5 rounded-[20px] overflow-hidden border border-purple cursor-pointer ${activeQuestion === '5' ? 'open' : ''}`}
                                ...
                                <div
                                    className={`question-item px-7 py-5 rounded-[20px] overflow-hidden border border-purple cursor-pointer ${activeQuestion === '6' ? 'open' : ''}`}
