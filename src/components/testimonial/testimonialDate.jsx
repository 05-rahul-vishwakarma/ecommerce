...
const TestimonialDatePicker = () => {
  const setDate = useTestimonialStore((state) => state.setDate);
  useEffect(() => {
    // Init flatpickr
      ...
      nextArrow:
        ...
        onChange: (selectedDates) => {
          if (selectedDates.length > 0) {
            setDate(selectedDates[0]); // Update the store with the selected date
          }
        },
    });
  }, [setDate]);
...
export default TestimonialDatePicker;
