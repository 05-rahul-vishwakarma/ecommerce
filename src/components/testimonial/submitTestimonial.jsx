...
export default function SubmitTestimonial() {
  ...
  const sendTestimonialtData = async () => {
    const { customerName, customerImage, date, rating, description } =
    ...
    const token =
      "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJQSyI6IlNVQkhJX0VfTFREX1VTRVIjMGZiZjUxOTYtYjM4MC00M2NmLTk2OTgtYTAxZGFjMDkzYjcxIiwiU0siOiJQUk9GSUxFIzBmYmY1MTk2LWIzODAtNDNjZi05Njk4LWEwMWRhYzA5M2I3MSIsImlhdCI6MTczNzQ2MDEyNiwiZXhwIjoxNzQwMDUyMTI2fQ.y2RNnn9LMd3ZsWqOqKeNoRv5CAxSNuS-pC-raskg3f0";
  ...
  return (
    <button
      onClick={sendTestimonialtData}
      className="m-4 mb-4 mr-4 mt-8 flex w-[40%] justify-center justify-self-end rounded-[7px] bg-primary p-[13px] text-center font-medium text-white  hover:bg-opacity-90 "
    >
      Submit
    </button>
  );
