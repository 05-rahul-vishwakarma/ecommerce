              ...
              <div className="product-infor px-4">
                ...
                <div className="list-action mt-6">
                      ...
                      {selectedProduct?.imageURLs?.map((image, index) => (
                        <div
                          ...
                          className={`color-item w-8 h-8 rounded-[10px] duration-300 relative ${
                            activeColor === image.color.clrCode
                              ? "ring-2 ring-purple"
                              : ""
                          }`}
                  ...
                  <div className="choose-quantity flex items-center max-xl:flex-wrap lg:justify-between gap-5 mt-3">
                    ...
                    <div className="button-main w-full text-center bg-white text-secondary border border-purple mb-3">
                      Add To Cart
                    </div>
                  </div>

                  <Link href="/checkout" className="button-block mt-5">
