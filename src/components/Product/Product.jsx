...
const Product = ({ product }) => {
  ...
  return (
    <div
      ...
      key={product?.SK}
      className="product-main cursor-pointer block product-item grid-type"
    >
      <div className="product-thumb bg-white relative overflow-hidden rounded-2xl">
        ...
        >
          <div className="add-wishlist-btn w-[32px] h-[32px] flex items-center justify-center rounded-[10px] bg-white text-secondary duration-300 relative active">
      ...
      <div className="product-infor mt-4 lg:mb-7">
        <div className="product-sold sm:pb-4 pb-2">
          ...
          <div className="flex items-center justify-between gap-3 gap-y-1 flex-wrap mt-2">
            <div className="text-button-uppercase">
              <span className="text-purple2 max-sm:text-xs">Sold: </span>
              <span className="max-sm:text-xs">{product?.quantity - 50}</span>
            </div>
            <div className="text-button-uppercase">
              <span className="text-purple2 max-sm:text-xs">Available: </span>
        ...
        <div className="product-price-block flex items-center gap-2 flex-wrap mt-1 duration-300 relative z-[1]">
          ...
          {product?.discount > 0 && (
            <>
              <div className="product-origin-price caption1 text-purple2">
