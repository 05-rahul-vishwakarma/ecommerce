...
import { getAuthHeaders, updateProfile } from "@/api/baseApi";
                    ...
                    <table className="w-full max-[1400px]:w-[700px] max-md:w-[700px]">
                      ...
                      <tbody>
                        ...
                        <tr className="item duration-300 border-b border-line">
                          ...
                          <td className="py-3 price">$45.00</td>
                          <td className="py-3 text-right">
                            <span className="tag px-4 py-1.5 rounded-full bg-opacity-10 bg-purple text-white caption1 font-semibold">
                              Delivery
                            </span>
                          </td>
                        </tr>
