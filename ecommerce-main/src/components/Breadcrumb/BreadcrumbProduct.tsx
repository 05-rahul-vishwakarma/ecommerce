        ...
        <div className="main bg-surface md:pt-[88px] pt-[70px] pb-[14px]">
          <div className="container flex items-center justify-between flex-wrap gap-3">
            <div className="left flex items-center gap-1">
              ...
              <Icon.CaretRight size={12} className="text-secondary" />
              <div className="caption1 text-secondary">Product</div>
              <Icon.CaretRight size={12} className="text-secondary" />
              ...
              {productId !== null && Number(productId) >= 2 ? (
                <>
                  <div
                    ...
                    className="flex items-center cursor-pointer text-secondary hover:text-secondary border-r border-line pr-3"
                  >
                  ...
                  <div
                    onClick={() => handleDetailProduct(Number(productId) + 1)}
                    className="flex items-center cursor-pointer text-secondary hover:text-secondary"
                  >
                    <span className="caption1 pr-1">Next Product</span>
                    <Icon.CaretCircleRight className="text-2xl text-secondary" />
                  </div>
                </>
              ) : (
                <>
