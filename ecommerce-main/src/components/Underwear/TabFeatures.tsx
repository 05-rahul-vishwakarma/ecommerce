            ...
            <div className="menu-tab flex items-center gap-2  py-2 px-1 bg-custom-purple-color rounded-2xl text-white">
              {["best sellers", "on sale", "new arrivals"].map(
                (item, index) => (
                  <div
                    key={index}
                    className={`tab-item relative text-lg leading-normal tracking-[0.5px] py-2 px-5 cursor-pointer duration-500 hover:text-white ${
                  ...
                  >
                    {activeTab === item && (
                      <motion.div
                        ...
                        className="absolute inset-0 rounded-2xl bg-[rgb(255,255,255,0.1)] text-secondary shadow-black "
                      ></motion.div>
                    )}
